...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_SESSION['username'])) {
        ...
        $checkQuantity = "SELECT Quantity FROM phone_details WHERE Pro_Id = $productId";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if ($currentQuantity > 0) {
                ...
                $updateQuantity = "UPDATE phone_details SET Quantity = '$newQuantity' WHERE Pro_Id = '$productId'";
...
?>
                        ...
                        <script>
                            Swal.fire({
                                ...
                                onClose: () => {
                                    window.location.href = 'PHONES-CustomerSide.php';
                                }
                            });
                        </script>
<?php
