...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['username'])) {
        ...
        $checkQuantity = "SELECT Quantity FROM accessorie_details WHERE Pro_Id = $productId";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if ($currentQuantity > 0) {
                ...
                $updateQuantity = "UPDATE accessorie_details SET Quantity = '$newQuantity' WHERE Pro_Id = '$productId'";
                    ...
                    if ($conn->query($sql)) {
                        ...
                        <script>
                            Swal.fire({
                                ...
                                onClose: () => {
                                    window.location.href = 'ACCESSORIESCustomerSide.php'; 
                                }
                            });
                        </script>
                        <?php
