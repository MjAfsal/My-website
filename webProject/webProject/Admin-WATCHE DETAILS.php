...
$query = "select * from watche_details";
    ...
    <table align="center" border="1px" style="width:600px; line-height:40px;">
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
            <tr>
                ...
                <td><a href="update-watche-admin.php?id=<?php echo $row['Pro_Id']; ?>">Update</a></td>
                <td><a href="delete-watches-admin.php?id=<?php echo $row['Pro_Id']; ?>">Delete</a></td>
            </tr>
        <?php } ?>
