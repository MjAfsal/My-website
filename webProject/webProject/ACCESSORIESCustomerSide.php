...
<body>
    ...
    <header>
        ...
        <div class="header-buttons">
            ...
            <button type="button"><a href="Response_Back_End.php"><i class='bx bx-log-out'></i></a></button>
        </div>
    </header>
    ...
    <div class="main-content">
        <div class="product-container">
            ...
            $productType = "accessorie_details";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($row['Quantity'] <= 0) {
                        ...
                        echo '<button type="button"><a href="Buy_Now_Form-accessories.php?productId=' . $row['Pro_Id'] . '&productName=' . urlencode($row['Pro_Name']) . '&price=' . $row['Price'] . '">Buy Now</a></button>';
                    }
